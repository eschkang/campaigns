...
## Premise
Nova Roma begins as an established settlement (see manifest.json for population) with new leadership aiming to look outward and make the world better through trade, diplomacy, and infrastructure.
...
Example:
CI: v2.7 | RStart Conditions: settlement; RStarting Population: see manifest.json; RNarrative Framing: neutral→outward-focused | MAJOR
